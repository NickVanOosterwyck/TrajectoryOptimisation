    ...
    for i=1:nPieces
        switch sol(j).input.sTrajType
            ...
            otherwise
                ...
                if i>1
                    br_q1=subs(q(i-1),t,breaks(i));
                    br_q2=subs(q(i),t,breaks(i));
                    plot([breaks(i) breaks(i)],[br_q1 br_q2],'LineWidth'...
                        ,1.2,'Color',obj.colorMap(obj.iPlot,:)...
                        ,'DisplayName',num2str(label),...
                        'HandleVisibility','off');
                end
                % plot start and endpoint
                br_q1=subs(q(1),t,breaks(1));
                br_q2=subs(q(end),t,breaks(end));
    ...
    for i=1:nPieces
        switch sol(j).input.sTrajType
            ...
            otherwise
                ...
                % plot connecting lines
                if i>1
                    br_q1=subs(qd1(i-1),t,breaks(i));
                    br_q2=subs(qd1(i),t,breaks(i));
                    plot([breaks(i) breaks(i)],[br_q1 br_q2],'LineWidth'...
                        ,1.2,'Color',obj.colorMap(obj.iPlot,:)...
                        ,'DisplayName',num2str(label),...
                        'HandleVisibility','off');
    ...
    for i=1:nPieces
        switch sol(j).input.sTrajType
            ...
            otherwise
                ...
                % plot connecting lines
                if i>1
                    br_q1=subs(qd2(i-1),t,breaks(i));
                    br_q2=subs(qd2(i),t,breaks(i));
                    plot([breaks(i) breaks(i)],[br_q1 br_q2],'LineWidth'...
                        ,1.2,'Color',obj.colorMap(obj.iPlot,:)...
                        ,'DisplayName',num2str(label),...
                        'HandleVisibility','off');
    ...
    for i=1:nPieces
        switch sol(j).input.sTrajType
            ...
            otherwise
                ...
                % plot connecting lines
                if i>1
                    br_q1=subs(Tm(i-1),t,breaks(i));
                    br_q2=subs(Tm(i),t,breaks(i));
                    plot([breaks(i) breaks(i)],[br_q1 br_q2],'LineWidth'...
                        ,1.2,'Color',obj.colorMap(obj.iPlot,:)...
                        ,'DisplayName',num2str(label),...
                        'HandleVisibility','off');
